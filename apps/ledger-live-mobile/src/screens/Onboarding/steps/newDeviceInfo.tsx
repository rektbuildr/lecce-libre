...
import { normalize } from "LLM@helpers/normalizeSize";
...
const images = {
  light: [
    require("LLM@images/illustration/Light/_049.png"),
    require("LLM@images/illustration/Light/_073.png"),
    require("LLM@images/illustration/Light/_070.png"),
    require("LLM@images/illustration/Light/_069.png"),
    require("LLM@images/illustration/Light/_066.png"),
  ],
};
