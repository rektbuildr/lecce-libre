...
const images = {
  light: {
    RestoreRecovery: require("LLM@images/illustration/Light/_067.png"),
    RestoreRecoveryStep1: require("LLM@images/illustration/Light/_067.png"),
    PinCode: require("LLM@images/illustration/Light/_062.png"),
    PinCodeInstructions: require("LLM@images/illustration/Light/_062.png"),
    ExistingRecovery: require("LLM@images/illustration/Light/_059.png"),
    ExistingRecoveryStep1: require("LLM@images/illustration/Light/_061.png"),
    ExistingRecoveryStep2: require("LLM@images/illustration/Light/_061.png"),
  },
  dark: {
    RestoreRecovery: require("LLM@images/illustration/Dark/_067.png"),
    RestoreRecoveryStep1: require("LLM@images/illustration/Dark/_067.png"),
    PinCode: require("LLM@images/illustration/Dark/_062.png"),
    PinCodeInstructions: require("LLM@images/illustration/Dark/_062.png"),
    ExistingRecovery: require("LLM@images/illustration/Dark/_059.png"),
    ExistingRecoveryStep1: require("LLM@images/illustration/Dark/_061.png"),
    ExistingRecoveryStep2: require("LLM@images/illustration/Dark/_061.png"),
  },
};
