...
import { getSupportedCounterValues } from "LLM@reducers/settings";
import { setMarketCounterCurrency } from "LLM@actions/settings";
...
const RenderEmptyList = ({ theme, search }: { theme: string; search: string }) => (
  ...
  <Flex alignItems="center">
    <Image
      ...
      source={
        theme === "light"
          ? require("LLM@images/marketNoResultslight.png")
          : require("LLM@images/marketNoResultsdark.png")
      }
    />
