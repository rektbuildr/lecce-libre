...
import { ManagerTab } from "LLM@const/manager";
...
import NoResultsFound from "LLM@icons/NoResultsFound";
...
import { TAB_BAR_SAFE_HEIGHT } from "LLM@components/TabBar/shared";
import type {
  BaseComposite,
  StackNavigatorProps,
