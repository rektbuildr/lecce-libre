...
import ConfirmationModal from "LLM@components/ConfirmationModal";
...
import SectionSeparator from "LLM@components/SectionSeparator";
import SendRowsCustom from "LLM@components/SendRowsCustom";
import SendRowsFee from "LLM@components/SendRowsFee";
import TranslatedError from "LLM@components/TranslatedError";
import { NavigatorName, ScreenName } from "LLM@const";
import AlertTriangle from "LLM@icons/AlertTriangle";
import { useTransactionChangeFromNavigation } from "LLM@logic/screenTransactionHooks";
import { accountScreenSelector } from "LLM@reducers/accounts";
import SummaryAmountSection from "LLM@screens/SendFunds/SummaryAmountSection";
import SummaryFromSection from "LLM@screens/SendFunds/SummaryFromSection";
import SummaryNft from "LLM@screens/SendFunds/SummaryNft";
import SummaryToSection from "LLM@screens/SendFunds/SummaryToSection";
import SummaryTotalSection from "LLM@screens/SendFunds/SummaryTotalSection";
