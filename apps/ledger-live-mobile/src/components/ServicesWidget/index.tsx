...
import LedgerRecoverLogoLight from "LLM@images/ledger_recover_light.png";
import LedgerRecoverBackground from "LLM@images/ledger_recover_card_background.png";
