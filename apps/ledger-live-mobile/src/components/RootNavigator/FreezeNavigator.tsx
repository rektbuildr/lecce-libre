...
import Info from "LLM@screens/FreezeFunds/01-Info";
import Amount from "LLM@screens/FreezeFunds/02-Amount";
import SelectDevice from "LLM@screens/SelectDevice";
import ConnectDevice from "LLM@screens/ConnectDevice";
import ValidationSuccess from "LLM@screens/FreezeFunds/04-ValidationSuccess";
import ValidationError from "LLM@screens/FreezeFunds/04-ValidationError";
