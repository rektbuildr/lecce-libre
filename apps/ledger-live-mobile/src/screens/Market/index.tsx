...
import WalletTabSafeAreaView from "LLM@components/WalletTab/WalletTabSafeAreaView";
import { setMarketFilterByStarredAccounts, setMarketRequestParams } from "LLM@actions/settings";
...
const noResultIllustration = {
  dark: require("LLM@images/illustration/Dark/_051.png"),
  light: require("LLM@images/illustration/Light/_051.png"),
};

const noNetworkIllustration = {
  dark: require("LLM@images/illustration/Dark/_078.png"),
  light: require("LLM@images/illustration/Light/_078.png"),
};
