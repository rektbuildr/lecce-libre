...
const setupLedgerImg = require("LLM@images/illustration/Shared/_SetupLedger.png");

// eslint-disable-next-line @typescript-eslint/no-var-requires
const syncCryptoImg = require("LLM@images/illustration/Shared/_SyncFromDesktop.png");
