...
import SendCoin from "LLM@screens/SelectAccount";
import SendCollection from "LLM@screens/SendFunds/01b-SelectCollection";
import SendNft from "LLM@screens/SendFunds/01c-SelectNft";
import SendSelectRecipient from "LLM@screens/SendFunds/02-SelectRecipient";
import SendAmountCoin from "LLM@screens/SendFunds/03a-AmountCoin";
import SendAmountNft from "LLM@screens/SendFunds/03b-AmountNft";
import SendSummary from "LLM@screens/SendFunds/04-Summary";
import SelectDevice from "LLM@screens/SelectDevice";
import SendConnectDevice from "LLM@screens/ConnectDevice";
import SendValidationSuccess from "LLM@screens/SendFunds/07-ValidationSuccess";
import SendValidationError from "LLM@screens/SendFunds/07-ValidationError";
